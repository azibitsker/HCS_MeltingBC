...
double SolidCond_Ray::HeatCondSolver(vector<double>& f0, vector<double>& x0, vector<double>& x, double dt, double qdot0, const int Nx, int ind_t,ofstream &IterationsFile,ofstream & NcellsFile) {
...
// Generate initial material grid including nodes for the two ghost cells using geometric series
void SolidCond_Ray::GenerateGeomGrid(vector<double>& x0, const int Nx) {
    // Generate the initial material grid. Fill out the array x0 with location of the
    // cells boundaries using geometric series
...
void SolidCond_Ray::GenerateUniformGrid(vector<double>& x0, double dx) {
    // Generate the initial material grid. Fill out the array x0 with location of the
    // cells boundaries using uniform series
    SolidCond_Ray SolidTemp;
    int Nx = round(SolidTemp.L0 / dx) + 3;
    double x=-dx;
...
// Update grid boundaries based on the computed recession rate sdot0
void SolidCond_Ray::ContractGridBoundaries(vector<double>& x0, vector<double>& x, double sdot0, double dt, const int Nx, int ind_t)
{
...
// Get a,b,c coefficients for Thomas algorithm
void SolidCond_Ray::Get_abcd_coeff(vector<double>& x0, vector<double>& x, vector<double>& f0, double qdot0, double sdot0, double dt, vector<double>& a, vector<double>& b, vector<double>& c, vector<double>& d, const int Nx, int ind_t){
...
double SolidCond_Ray::GetMeltedLength(vector<double>& f, vector<double>& x0) {
...
double SolidCond_Ray::GetRecessionRate(vector<double>& f, vector<double>& x0, double dt) {
...
void SolidCond_Ray::EvaluateTemp(vector<double>& x0, vector<double>& x, vector<double>& f0, vector<double>& f, double qdot0, double sdot0, double dt, int ind_t, const int Nx)
{
